...
import {
    BoardDescriptionBottomTop,
    BoardDescriptionSide,
    ...
    return (
        <globalStateContext.Provider value={globalState}>
            <div id={"board-grid-container"}>
                ...
                <div
                    style={{ gridArea: "border1", backgroundColor: "black" }}
                ></div>
                <div
                    style={{ gridArea: "border2", backgroundColor: "black" }}
                ></div>
                <div
                    style={{ gridArea: "border3", backgroundColor: "black" }}
                ></div>
                <div
                    style={{ gridArea: "border4", backgroundColor: "black" }}
                ></div>
